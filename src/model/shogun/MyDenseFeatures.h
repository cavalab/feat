...
#ifndef _MYDENSEFEATURES__H__
#define _MYDENSEFEATURES__H__
...
template<class ST> class CMyDenseFeatures;
 ...
 *
 * \li bool matrix - CMyDenseFeatures<bool>
 * \li 8bit char matrix - CMyDenseFeatures<char>
 * \li 8bit Byte matrix - CMyDenseFeatures<uint8_t>
 * \li 16bit Integer matrix - CMyDenseFeatures<int16_t>
 * \li 16bit Word matrix - CMyDenseFeatures<uint16_t>
 * \li 32bit Integer matrix - CMyDenseFeatures<int32_t>
 * \li 32bit Unsigned Integer matrix - CMyDenseFeatures<uint32_t>
 * \li 32bit Float matrix - CMyDenseFeatures<float32_t>
 * \li 64bit Float matrix - CMyDenseFeatures<float64_t>
 ...
 * \li 96bit Float matrix - CMyDenseFeatures<floatmax_t>
 *
 ...
 */
template<class ST> class CMyDenseFeatures: public CDotFeatures
{
public:
	/** constructor
	 *
	 ...
	 */
	CMyDenseFeatures(int32_t size = 0);

	/** copy constructor */
	CMyDenseFeatures(const CMyDenseFeatures & orig);

	/** constructor
	 *
	 * @param matrix feature matrix
	 */
	CMyDenseFeatures(SGMatrix<ST> matrix);
	 ...
	 */
	CMyDenseFeatures(ST* src, int32_t num_feat, int32_t num_vec);

	/** constructor loading features from file
	 *
	 * @param loader File object via which to load data
	 */
	CMyDenseFeatures(CFile* loader);
	 ...
	 */
	CMyDenseFeatures<ST>* get_transposed();
	...
	/** checks if the contents of this CMyDenseFeatures object are the same to
	 * the contents of rhs
	 *
	 * @param rhs other CMyDenseFeatures object to compare to this one
	 * @return whether they represent the same information
	 */
	virtual bool is_equal(CMyDenseFeatures* rhs);
	 ...
	 *
	 */
	static CMyDenseFeatures* obtain_from_generic(CFeatures* const base_features);
