...
cdef extern from "feat.h" namespace "FT":
    cdef cppclass Feat: 
        ...
        Feat(int pop_size, int gens, string ml, 
               ...
               string feature_names, bool backprop, int iters, double lr,
...
cdef class PyFeat:
    ...
    def __cinit__(self,int pop_size, int gens, string ml, bool classification, int verbosity, 
                  ...
                  string scorer, string feature_names, bool backprop, int iters, double lr, 
                  int n_threads):
        ...
        feature_names, backprop, iters, lr, n_threads)
